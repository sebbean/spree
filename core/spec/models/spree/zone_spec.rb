  ...
  context "#include?" do
    ...
    context "when zone is country type" do
      ...
      it "should be true" do
        expect(country_zone.include?(address)).to eq(true)
      end
    end
    ...
    context "when zone is state type" do
      ...
      it "should be true" do
        expect(state_zone.include?(address)).to eq(true)
      end
    end
  end
  ...
  context "#contains?" do
    ...
    context "when the target has no members" do
      ...
      it "should be false" do
        expect(@source.contains?(@target)).to eq(false)
      end
    end
    ...
    context "when both zones are the same zone" do
      ...
      it "should be true" do
        expect(@source.contains?(@target)).to eq(true)
      end
    end
  ...
  context "#save" do
    context "when default_tax is true" do
      it "should clear previous default tax zone" do
        ...
        expect(zone1.reload.default_tax).to eq(false)
      end
    end
