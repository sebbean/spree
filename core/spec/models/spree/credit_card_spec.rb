...
describe Spree::CreditCard do
  ...
  context "#can_capture?" do
    it "should be true if payment is pending" do
      ...
      expect(credit_card.can_capture?(payment)).to eq(true)
    end
  ...
  context "#can_void?" do
    it "should be true if payment is not void" do
      ...
      expect(credit_card.can_void?(payment)).to eq(true)
    end
  end
  ...
  context "#can_credit?" do
    it "should be false if payment is not completed" do
      ...
      expect(credit_card.can_credit?(payment)).to eq(false)
    end
  ...
  context "#valid?" do
    ...
    it "validates name presence" do
      credit_card.valid?
      expect(credit_card.errors_on(:name).size).to eq(1)
    end
